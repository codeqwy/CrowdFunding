...
function myAddHoverDom(treeId, treeNode) {
  ...
  // 按照一定规则设置按钮组span的id
  let btnGroupId = "btnGroupTreeDemo_" + treeNode.id;
...
function generateTree() {
  $.ajax({
    ...
    error: function (response) {
      layer.msg("请求出错！错误码：" + response.status + "错误信息：" + response.statusText);
    }
  });
}